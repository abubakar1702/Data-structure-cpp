...
void delteAnyNode(Node* nodeName){
    Node* previous;
    Node* current;
...
void InsertBegining(int d){               //Alternative way
    Node* new_node = new Node();
    new_node->data=d;
    new_node->next=NULL;
    if(head!=NULL){
...
Node* InsertBegining2(int d){               //Alternative way2
    Node* new_node = new Node();
    new_node->data=d;
    new_node->next=NULL;
    if(head!=NULL){
...
void InsertBegining3(Node** head, int x){
    Node* new_node = new Node();
    new_node->data = x;
    new_node->next=NULL;
